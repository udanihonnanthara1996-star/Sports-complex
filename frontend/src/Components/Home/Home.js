  ...
  return (
    <div>
      ...
      <div className="contain">
        ...
        <Link to="/bookingForm" className="btn2">
          Book Now
        </Link>
      </div>
      ...
      <section className="hero">
        <div className="hero-content">
          ...
          <div className="hero-buttons">
            <Link to="/bookingForm" className="btn btn-primary">Book a Facility Now</Link>
            <button type="button" className="btn btn-outline">Explore Features</button>
          </div>
        </div>
      </section>
      ...
      <footer className="footer">
        <div className="footer-container">
          ...
          <div className="footer-col">
            ...
            <ul>
              <li>
                <a href="https://www.google.com/maps/search/237/A+Malabe,+Kollupitiya" target="_blank" rel="noopener noreferrer">237/A Malabe, Kollupitiya</a>
              </li>
              <li>
                <a href="tel:+94776957704">+94776957704</a>
              </li>
              <li>
                <a href="tel:+94776955505">+94776955505</a>
              </li>
              <li>
                <a href="mailto:sport.lk@gmail.com">sport.lk@gmail.com</a>
              </li>
            </ul>
          </div>
          ...
          <div className="footer-col">
            ...
            <ul>
              ...
              <li>
                <button type="button" className="link-button">Cookie policy</button>
              </li>
            </ul>
          </div>
        </div>
